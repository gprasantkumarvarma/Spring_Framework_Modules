...
public class MyDemologgingAspect {
	...
	*/
	...
	public Object aroundFortune(ProceedingJoinPoint theProceeding) throws Throwable {
		...
		System.out.println("Duration od execution ::"+duration/1000 + " seconds");
	...
	public void afterFinallyFineAccountAdvice(JoinPoint theJoinpoint) {
		...
		System.out.println("@@@After :: afterFinallyFineAccountAdvice");
				
				String method = theJoinpoint.getSignature().toShortString();
				System.out.println("@@@After finally Method Name ::"+method);
