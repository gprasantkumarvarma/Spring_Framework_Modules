...
public class Customer {
	...
	/*
	 * public int getFeePasses() { return feePasses; }
	 * 
	 * 
	 * public void setFeePasses(int freePasses) { this.feePasses = freePasses; }
	 */

	public Integer getFeePasses() {
		return feePasses;
	}

	public void setFeePasses(Integer freePasses) {
		this.feePasses = freePasses;
	}
