...
public class Note {
	...
	public Note(int noteId, String noteTitle, String noteContent, String noteStatus, Date noteCreationDate, String noteCreatedBy, List<Reminder> reminders, Category category) {
		this.noteId = noteId;
